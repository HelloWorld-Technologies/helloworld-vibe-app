...
export const MENU_SECTIONS: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "helloworld-living",
        label: "Helloworld Living",
        icon: "helloworldLiving",
      },
...
export const TENANT_MORE_ITEMS: MenuItem[] = [
  { id: "about", label: "About", icon: "tenantAbout" },
  {
    ...
    icon: "tenantPrivacyPolicy",
  },
  {
    id: "tenancy-policy",
    label: "Tenancy Policy",
    icon: "tenantTenancyPolicy",
  },
  { id: "logout", label: "Logout", icon: "tenantLogout" },
];

export function buildTenantMenuSections(
  includeMoveInSteps = false,
): MenuSection[] {
  return [
    {
      id: "account",
